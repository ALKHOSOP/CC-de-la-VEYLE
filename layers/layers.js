...
var format_POINT_KM_2 = new ol.format.GeoJSON();
var features_POINT_KM_2 = format_POINT_KM_2.readFeatures(json_POINT_KM_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_POINT_KM_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_POINT_KM_2.addFeatures(features_POINT_KM_2);
var lyr_POINT_KM_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_POINT_KM_2, 
                style: style_POINT_KM_2,
                interactive: true,
                title: '<img src="styles/legend/POINT_KM_2.png" /> POINT_KM'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_VV_DIAG_LINEAIRE_1.setVisible(true);lyr_POINT_KM_2.setVisible(true);lyr_VV_DIAG_PTS_DURS_3.setVisible(false);lyr_POLES_COMMUNES_4.setVisible(false);lyr_POLES_EQUIPTS_STRUCT_5.setVisible(false);
var layersList = [lyr_OpenStreetMap_0,lyr_VV_DIAG_LINEAIRE_1,lyr_POINT_KM_2,lyr_VV_DIAG_PTS_DURS_3,lyr_POLES_COMMUNES_4,lyr_POLES_EQUIPTS_STRUCT_5];
...
lyr_POINT_KM_2.set('fieldAliases', {'fid': 'fid', 'LONGUEUR': 'LONGUEUR', });
...
lyr_POINT_KM_2.set('fieldImages', {'fid': 'TextEdit', 'LONGUEUR': 'TextEdit', });
...
lyr_POINT_KM_2.set('fieldLabels', {'fid': 'inline label', 'LONGUEUR': 'inline label', });
